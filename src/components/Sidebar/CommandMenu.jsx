...
export const CommandMenu = ({ open, setOpen }) => {
  ...
  }, [setOpen]); // Include setOpen as a dependency
  ...
  return (
    <Command.Dialog 
        ...
        <Command.List>
            ...
            <Command.Item className='flex cursor-pointer
            trainsition-colors p-2 text-sm text-stone-50
            hover:bg-stone-700 bg-stone-950 rounded 
            items-center gap-2'>
                <FiLogOut />
                Sign Out
            </Command.Item>
